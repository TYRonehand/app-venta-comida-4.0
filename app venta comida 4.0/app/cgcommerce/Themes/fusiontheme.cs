...
class FusionTheme : ThemeContainer152
{
    ...
    public FusionTheme()
    {
		...
		border_color = ColorTranslator.FromHtml(aux.get_color1());
        ...
        SetColor("Sides", border_color.R,border_color.G,border_color.B);
        SetColor("Gradient1", border_color.R,border_color.G,border_color.B);
        SetColor("Gradient2", border_color.R,border_color.G,border_color.B);
    ...
    protected override void ColorHook()
    {
        ...
        C1 = ColorTranslator.FromHtml(aux.get_color3());
        C2 = ColorTranslator.FromHtml(aux.get_color3());
        C3 = ColorTranslator.FromHtml(aux.get_color3());
...
class FusionButton : ThemeControl152
{
    ...
    public FusionButton()
    {
        SetColor("DownGradient1", 255, 255, 255);
        SetColor("DownGradient2", 255, 255, 255);
        SetColor("NoneGradient1", 255, 255, 255);
        SetColor("NoneGradient2", 255, 255, 255);
        SetColor("TextShade", 30, Color.Black);
        SetColor("Text", Color.White);
        SetColor("Border1", 255, 255, 255);
        SetColor("Border2", 255, 255, 255);
    }
