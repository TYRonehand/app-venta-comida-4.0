...
namespace cgcommerce
{
	partial class clientes
	{
		...
		private void InitializeComponent()
		{
			...
			this.Agenda_dgv_todos_clientes = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.Agenda_dgv_todos_clientes)).BeginInit();
			this.SuspendLayout();
			// 
			// fusionTheme1
			// 
		...
		bloom11};
			...
			this.fusionTheme1.Text = "Clientes";
			...
			// 
			this.splitContainer1.Panel1.Controls.Add(this.Agenda_dgv_todos_clientes);
			// 
			...
			this.splitContainer1.Panel2.Controls.Add(this.btn_buscar_cliente);
			this.splitContainer1.Panel2.Controls.Add(this.btn_eliminar_cliente);
			this.splitContainer1.Panel2.Controls.Add(this.btn_nuevo_cliente);
			...
			// 
			// Agenda_dgv_todos_clientes
			// 
			this.Agenda_dgv_todos_clientes.AllowUserToAddRows = false;
			this.Agenda_dgv_todos_clientes.AllowUserToDeleteRows = false;
			this.Agenda_dgv_todos_clientes.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
			| System.Windows.Forms.AnchorStyles.Left) 
			| System.Windows.Forms.AnchorStyles.Right)));
			this.Agenda_dgv_todos_clientes.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
			this.Agenda_dgv_todos_clientes.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllCells;
			this.Agenda_dgv_todos_clientes.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			...
			this.Agenda_dgv_todos_clientes.DefaultCellStyle = dataGridViewCellStyle1;
			this.Agenda_dgv_todos_clientes.Location = new System.Drawing.Point(3, 4);
			this.Agenda_dgv_todos_clientes.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.Agenda_dgv_todos_clientes.Name = "Agenda_dgv_todos_clientes";
			this.Agenda_dgv_todos_clientes.ReadOnly = true;
			this.Agenda_dgv_todos_clientes.Size = new System.Drawing.Size(641, 488);
			this.Agenda_dgv_todos_clientes.TabIndex = 0;
			this.Agenda_dgv_todos_clientes.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.Agenda_dgv_todos_clientesCellContentClick);
			this.Agenda_dgv_todos_clientes.CellContentDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.Agenda_dgv_todos_clientesCellContentDoubleClick);
			// 
			// btn_listo
			// 
			this.btn_listo.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.btn_listo.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("btn_listo.BackgroundImage")));
			this.btn_listo.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			this.btn_listo.Location = new System.Drawing.Point(13, 428);
			this.btn_listo.Name = "btn_listo";
			this.btn_listo.Size = new System.Drawing.Size(64, 64);
			this.btn_listo.TabIndex = 72;
			this.toolTip1.SetToolTip(this.btn_listo, " Listo");
			this.btn_listo.UseVisualStyleBackColor = true;
			this.btn_listo.Click += new System.EventHandler(this.Btn_listoClick);
			// 
			// label4
			// 
			...
			this.btn_buscar_cliente.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			this.btn_buscar_cliente.Location = new System.Drawing.Point(14, 228);
			this.btn_buscar_cliente.Name = "btn_buscar_cliente";
			this.btn_buscar_cliente.Size = new System.Drawing.Size(64, 64);
			this.btn_buscar_cliente.TabIndex = 66;
			this.btn_buscar_cliente.UseVisualStyleBackColor = true;
			this.btn_buscar_cliente.Click += new System.EventHandler(this.Btn_buscar_clienteClick);
			// 
			// btn_eliminar_cliente
			// 
			this.btn_eliminar_cliente.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.btn_eliminar_cliente.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("btn_eliminar_cliente.BackgroundImage")));
			this.btn_eliminar_cliente.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			this.btn_eliminar_cliente.Location = new System.Drawing.Point(13, 130);
			this.btn_eliminar_cliente.Name = "btn_eliminar_cliente";
			this.btn_eliminar_cliente.Size = new System.Drawing.Size(64, 64);
			this.btn_eliminar_cliente.TabIndex = 65;
			this.btn_eliminar_cliente.UseVisualStyleBackColor = true;
			this.btn_eliminar_cliente.Click += new System.EventHandler(this.Btn_eliminar_clienteClick);
			// 
			// btn_nuevo_cliente
			// 
			this.btn_nuevo_cliente.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.btn_nuevo_cliente.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("btn_nuevo_cliente.BackgroundImage")));
			this.btn_nuevo_cliente.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
			this.btn_nuevo_cliente.ForeColor = System.Drawing.Color.Black;
			this.btn_nuevo_cliente.Location = new System.Drawing.Point(13, 32);
			this.btn_nuevo_cliente.Name = "btn_nuevo_cliente";
			this.btn_nuevo_cliente.Size = new System.Drawing.Size(64, 64);
			this.btn_nuevo_cliente.TabIndex = 63;
			this.btn_nuevo_cliente.UseVisualStyleBackColor = true;
			this.btn_nuevo_cliente.Click += new System.EventHandler(this.Btn_nuevo_clienteClick);
			// 
			// btn_salir
			// 
		...
		bloom19};
			...
			((System.ComponentModel.ISupportInitialize)(this.Agenda_dgv_todos_clientes)).EndInit();
		...
		private System.Windows.Forms.DataGridView Agenda_dgv_todos_clientes;
